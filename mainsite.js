/* ==========================================================================
   ...
   NOTE: The old decorative "Animated market overview card" demo (formerly
   section 28 — MARKET_DEMO_SYMBOLS, tickMarketTickers(), tickMarketChart(),
   initMarketOverviewDemo()) has been REMOVED from this file. The hero
   section's animation is now driven by the separate candlestick-chart.js
   file (loaded via its own <script> tag in index.html), which renders the
   Gold/Bitcoin candlestick panel instead of the old ticker+line-chart demo.
   ========================================================================== */
